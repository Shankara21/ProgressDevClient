...
const routes: Routes = [
  ...
  { path: 'documents/pjd', component: IndexCategoryComponent },
  { path: 'documents/psd', component: IndexCategoryComponent },
  { path: 'documents/rmd', component: IndexCategoryComponent },
  { path: 'documents/pmd', component: IndexCategoryComponent },
